...
function generatorColorPalette(){
    colorPalette.inerHTML = '';
    for (let = i 1: i <= 5; i++){
        ...
        li.addEventListener('click', (e) => {
           let targetInput = e.target.parentNode.querySelector('ipnut[name="color"]');
           targetInput .select();
